...
#include "my_custom_interface/msg/detail/target_coordinates__rosidl_typesupport_fastrtps_c.h"
...
using _TargetCoordinates__ros_msg_type = my_custom_interface__msg__TargetCoordinates;
...
size_t get_serialized_size_my_custom_interface__msg__TargetCoordinates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TargetCoordinates__ros_msg_type * ros_message = static_cast<const _TargetCoordinates__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TargetCoordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_custom_interface__msg__TargetCoordinates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_interface
size_t max_serialized_size_my_custom_interface__msg__TargetCoordinates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_custom_interface__msg__TargetCoordinates;
    is_plain =
      (
...
static size_t _TargetCoordinates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_custom_interface__msg__TargetCoordinates(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_custom_interface, msg, TargetCoordinates)() {

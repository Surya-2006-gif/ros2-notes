...
{
  new (message_memory) my_custom_interface::msg::TargetCoordinates(_init);
}

void TargetCoordinates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_custom_interface::msg::TargetCoordinates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TargetCoordinates_message_member_array[2] = {
  {
    ...
    offsetof(my_custom_interface::msg::TargetCoordinates, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_interface::msg::TargetCoordinates, coordinates),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TargetCoordinates_message_members = {
  ...
  2,  // number of fields
  sizeof(my_custom_interface::msg::TargetCoordinates),
...
{
  return &::my_custom_interface::msg::rosidl_typesupport_introspection_cpp::TargetCoordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_custom_interface, msg, TargetCoordinates)() {
  return &::my_custom_interface::msg::rosidl_typesupport_introspection_cpp::TargetCoordinates_message_type_support_handle;
}

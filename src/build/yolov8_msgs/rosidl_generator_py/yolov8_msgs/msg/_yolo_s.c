...
bool yolov8_msgs__msg__yolo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._yolo.Yolo", full_classname_dest, 26) == 0);
  }
  yolov8_msgs__msg__Yolo * ros_message = _ros_message;
  {  // class_name
...
{
  /* NOTE(esteve): Call constructor of Yolo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._yolo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Yolo");

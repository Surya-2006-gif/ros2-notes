...
#include "yolov8_msgs/msg/detail/detections__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yolov8_msgs::msg::Yolo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yolov8_msgs::msg::Yolo &);
...
cdr_serialize(
  const yolov8_msgs::msg::Detections & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov8_msgs::msg::Detections & ros_message)
{
  // Member: detections
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yolov8_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Yolo(
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs::msg::Detections;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::Detections *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_msgs::msg::Detections *>(
    untyped_ros_message);
...
{
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_Detections__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_msgs, msg, Detections)() {
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_Detections__handle;
}

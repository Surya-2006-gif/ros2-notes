...
#include "yolov8_msgs/msg/detail/detections__rosidl_typesupport_fastrtps_c.h"
...
#include "yolov8_msgs/msg/detail/yolo__functions.h"  // detections

// forward declare type support functions
size_t get_serialized_size_yolov8_msgs__msg__Yolo(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_yolov8_msgs__msg__Yolo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolov8_msgs, msg, Yolo)();


using _Detections__ros_msg_type = yolov8_msgs__msg__Detections;
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, yolov8_msgs, msg, Yolo
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      yolov8_msgs__msg__Yolo__Sequence__fini(&ros_message->detections);
    }
...
size_t get_serialized_size_yolov8_msgs__msg__Detections(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detections__ros_msg_type * ros_message = static_cast<const _Detections__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_yolov8_msgs__msg__Yolo(
...
static uint32_t _Detections__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolov8_msgs__msg__Detections(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yolov8_msgs
size_t max_serialized_size_yolov8_msgs__msg__Detections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_yolov8_msgs__msg__Yolo(
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs__msg__Detections;
    is_plain =
      (
...
static size_t _Detections__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolov8_msgs__msg__Detections(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolov8_msgs, msg, Detections)() {

...
#include "yolov8_msgs/msg/detail/yolo__rosidl_typesupport_fastrtps_c.h"
...
using _Yolo__ros_msg_type = yolov8_msgs__msg__Yolo;
...
static uint32_t _Yolo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolov8_msgs__msg__Yolo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs__msg__Yolo;
    is_plain =
      (
...
static size_t _Yolo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolov8_msgs__msg__Yolo(

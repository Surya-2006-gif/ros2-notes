...
bool my_custom_interface__msg__target_coordinates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_custom_interface.msg._target_coordinates.TargetCoordinates", full_classname_dest, 61) == 0);
  }
  my_custom_interface__msg__TargetCoordinates * ros_message = _ros_message;
  {  // name
...
PyObject * my_custom_interface__msg__target_coordinates__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_custom_interface.msg._target_coordinates");

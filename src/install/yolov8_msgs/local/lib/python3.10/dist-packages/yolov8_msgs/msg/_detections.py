...
class Metaclass_Detections(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from yolov8_msgs.msg import Yolo
            if Yolo.__class__._TYPE_SUPPORT is None:
                Yolo.__class__.__import_type_support__()
...
class Detections(metaclass=Metaclass_Detections):
    ...
    _fields_and_field_types = {
        'detections': 'sequence<yolov8_msgs/Yolo>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yolov8_msgs', 'msg'], 'Yolo')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Yolo) for v in value) and
                 True), \
                "The 'detections' field must be a set or sequence and each value of type 'Yolo'"

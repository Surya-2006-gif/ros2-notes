...
{
  new (message_memory) yolov8_msgs::msg::Detections(_init);
}

void Detections_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolov8_msgs::msg::Detections *>(message_memory);
  typed_message->~Detections();
}

size_t size_function__Detections__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<yolov8_msgs::msg::Yolo> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<yolov8_msgs::msg::Yolo> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<yolov8_msgs::msg::Yolo> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const yolov8_msgs::msg::Yolo *>(
    get_const_function__Detections__detections(untyped_member, index));
  auto & value = *reinterpret_cast<yolov8_msgs::msg::Yolo *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolov8_msgs::msg::Yolo *>(
    get_function__Detections__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolov8_msgs::msg::Yolo *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detections_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolov8_msgs::msg::Yolo>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs::msg::Detections, detections),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detections_message_members = {
  ...
  1,  // number of fields
  sizeof(yolov8_msgs::msg::Detections),
...
get_message_type_support_handle<yolov8_msgs::msg::Detections>()
{
  return &::yolov8_msgs::msg::rosidl_typesupport_introspection_cpp::Detections_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov8_msgs, msg, Detections)() {
  return &::yolov8_msgs::msg::rosidl_typesupport_introspection_cpp::Detections_message_type_support_handle;
}
